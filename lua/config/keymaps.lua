...
nnoremap('<leader>cf', function() vim.fn.setreg('+', vim.fn.expand('%:t')) end, { desc = 'Copy filename' })
nnoremap('<leader>cp', function() vim.fn.setreg('+', vim.fn.expand('%')) end, { desc = 'Copy relative path' })
nnoremap('<leader>cP', function() vim.fn.setreg('+', vim.fn.expand('%:p')) end, { desc = 'Copy absolute path' })
